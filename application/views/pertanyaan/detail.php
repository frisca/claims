                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="float-left" style="margin-top: 10px;">Lihat Data Pertanyaan</h3>
                            </div>
                            <div class="card-body">
                                <table class="table table-striped table-bordered first">
                                    <tbody>
                                        <tr>
                                            <th>Urutan</th>
                                            <td><?php echo $pertanyaan->urutan;?></td>
                                        </tr>
                                        <tr>
                                            <th>Pertanyaan</th>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $pertanyaan->pilihan_jawaban_1;?></td>
                                        </tr>
                                        <tr>
                                            <th>Pilihan Jawaban 2</th>
                                            <td><?php echo $pertanyaan->pilihan_jawaban_2;?></td>
                                        </tr>
                                        <tr>
                                            <th>Status</th>
                                            <td>
