                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Status Approve</h2>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="float-left" style="margin-top: 10px;">Daftar Status Approve</h3>
                            </div>
                            <div class="card-body">
                                ...
                                <table class="table table-striped table-bordered first" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>Approve</td>
                                            <td>
                                                <a href="<?php echo base_url('status/detail_approve/' . $value->id_formulir);?>">
